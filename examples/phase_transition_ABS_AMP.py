...
partname = 'ABS_AMP'
synth_solver = ApproximateMessagePassing(stoptol=1e-20, maxiter=3000, debias="all")
...
def run_debias_type():
    ...
    synth_solvers = [ApproximateMessagePassing(stoptol=1e-14, maxiter=10000, debias=debias)
